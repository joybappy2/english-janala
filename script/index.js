...
const loadlevelword = ( id ) => {
  ...
  // lessonBtn.style.backgroundColor = "#422AD5"
  // lessonBtn.style.color = "white"
  // console.log("lesson btn clicked")
...
const displaylevelword = words => {
  ...
  if ( words.length == 0 ) {
    ...
    words.forEach( word => {
        ...
        <p class="font-bangla font-medium text-lg">"${word.meaning? word.meaning: "❌শব্দের অর্থ পাওয়া যায়নি"} / ${word.pronunciation? word.pronunciation : "❌শব্দের উচ্চারণ পাওয়া যায়নি"}"</p>
...
const displayLessons = jsonData => {
    ...
    for ( const data of jsonData ) {
        ...
        <button id="lesson-btn" onclick="loadlevelword(${data.level_no})" class="btn btn-outline btn-primary">
